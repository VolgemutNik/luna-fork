...
enum class Obelisk(val id: Int, val teleportTo: Position, val teleportFrom: Area, val objectPositions: List<Position>) {
    LEVEL_13(id = 14829,
            ...
            teleportFrom = Area(3154, 3618, 3158, 3622),
    ...
    LEVEL_19(id = 14830,
            ...
            teleportFrom = Area(3225, 3665, 3229, 3669),
    ...
    LEVEL_27(id = 14827,
            ...
            teleportFrom = Area(3033, 3730, 3037, 3733),
    ...
    LEVEL_35(id = 14828,
            ...
            teleportFrom = Area(3104, 3792, 3108, 3796),
    ...
    LEVEL_44(id = 14826,
            ...
            teleportFrom = Area(2978, 3864, 2982, 3868),
    ...
    LEVEL_50(id = 14831,
            ...
            teleportFrom = Area(3306, 3914, 3310, 3918),
    ...
    companion object {
         ...
         */
        val ALL: Set<Obelisk> = HashSet(values().asList())
    }
}